...
class BaseLayout extends Component {
  ...
  render() {
    ...
    return (
     ...
     <div className="appContainer">
      ...
      <Dialog open={ this.state.pleaseWaitVisible } disableBackdropClick={ true } disableEscapeKeyDown={ true }//define the please wait popup 阻止了1.点击关闭2.esc键关闭
  ...
  } /* End render(). 判断view类型来render component*/
